...
urlpatterns = [
        ...
        path('medicine_routes/',views.medicine_routes, name="medicine_routes"),
        path('medicine-unit-measures/', views.medicine_unit_measures, name='medicine_unit_measures'),
        path('add_service/',views.add_service, name="add_service"),
        path('new_consultation_order/',views.new_consultation_order, name="new_consultation_order"),
        path('fetch_prescription_counts_view/',views.fetch_prescription_counts_view, name="fetch_prescription_counts_view"),
        path('fetch_order_counts_view/',views.fetch_order_counts_view, name="fetch_order_counts_view"),
        path('fetch_radiology_order_counts_view/',views.fetch_radiology_order_counts_view, name="fetch_radiology_order_counts_view"),
        path('fetch_procedure_order_counts_view/',views.fetch_procedure_order_counts_view, name="fetch_procedure_order_counts_view"),
        path('new_radiology_order/',views.new_radiology_order, name="new_radiology_order"),
        path('new_procedure_order/',views.new_procedure_order, name="new_procedure_order"),
        ...
        path('delete_ambulance_activity/',views.delete_ambulance_activity, name="delete_ambulance_activity"),
        path('add-ambulance-activity/', views.add_ambulance_activity, name='add_ambulance_activity'),
        path('ambulance-activities/', views.ambulance_activity_list, name='ambulance_activity_list'),
        ...
        path('resa_clinic/dashboard',views.dashboard, name="dashboard"),
        ...
        path('delete_ambulance_route', views.delete_ambulance_route, name='delete_ambulance_route'),
        path('resa/new-request',views.add_request, name="add_request"),
        path('resa/add_or_edit_ambulance_route',views.add_or_edit_ambulance_route, name="add_or_edit_ambulance_route"),
        path('ambulance-routes/', views.ambulance_route_list, name='ambulance_route_list'),
        path('resa/update-staff-status',views.update_staff_status, name="update_staff_status"),
        path('resa/update_vehicle_status',views.update_vehicle_status, name="update_vehicle_status"),
        ...
        path('delete_frequency/', views.delete_frequency, name='delete_frequency'),
        path('orders/<str:date>/', views.orders_by_date, name='orders_by_date'),
        path('prescription-frequencies/', views.prescription_frequency_list, name='prescription_frequency_list'),
        path('diagnosis/', views.diagnosis_list, name='diagnosis_list'),
        path('all_orders_view/', views.all_orders_view, name='all_orders_view'),
        path('generate_invoice_bill/<int:order_id>/', views.generate_invoice_bill, name='generate_invoice_bill'),
        ...
        path('ambulance_order_view/',views.ambulance_order_view, name="ambulance_order_view"), 
        path('ambulance_order_detail/<int:order_id>/', views.ambulance_order_detail, name='ambulance_order_detail'), 
        path('patients/<int:patient_id>/visits/<int:visit_id>/ambulance_order/<int:ambulance_id>/', views.save_ambulance_order, name='edit_ambulance_order'), 
        path('delete_ambulancecardorder/', views.delete_ambulancecardorder, name='delete_ambulancecardorder'),
        path('delete_ambulancedorder/', views.delete_ambulancedorder, name='delete_ambulancedorder'),
        path('hospital-vehicles/', views.hospital_vehicle_list, name='hospital_vehicle_list'),
        ...
        path('vehicle_detail/<int:order_id>/', views.vehicle_detail, name='vehicle_detail'),   
        ...
        path('import_ambulance_route_list/', imports.import_ambulance_route_list, name='import_ambulance_route_list'),
        ...
        path('import_prescription_frequency/', imports.import_prescription_frequency, name='import_prescription_frequency'),
        path('import_ambulance_activity_list/', imports.import_ambulance_activity_list, name='import_ambulance_activity_list'),
        path('import_medicine_routes_records/', imports.import_medicine_routes_records, name='import_medicine_routes_records'),
        path('import_medicine_unit_measures_records/', imports.import_medicine_unit_measures_records, name='import_medicine_unit_measures_records'),
