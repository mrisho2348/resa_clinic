...
from .models import Category, Company, DiseaseRecode, InsuranceCompany, InventoryItem, Medicine, PathodologyRecord, Patients, Procedure, Referral, Service, Staffs, Supplier
