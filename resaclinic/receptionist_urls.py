...
urlpatterns = [
        ...
        path('ambulance_order/', ReceptionistView.ambulance_order_create_or_update, name='ambulance_order_create_or_update'),
        path('ambulance_order/<int:order_id>/', ReceptionistView.ambulance_order_create_or_update, name='ambulance_order_edit'),
        path('update_orderpayment_status/', ReceptionistView.update_orderpayment_status, name='update_orderpayment_status'),
        ...
        path('delete_ambulancecardorder/', ReceptionistView.delete_ambulancecardorder, name='delete_ambulancecardorder'),
        path('delete_ambulancedorder/', ReceptionistView.delete_ambulancedorder, name='delete_ambulancedorder'),
        path('vehicle_detail/<int:order_id>/', ReceptionistView.vehicle_detail, name='vehicle_detail'),    
