...
urlpatterns = [      
        ...
        path('save_patient_medication_allergy/<int:patient_id>/',views.save_patient_medication_allergy, name="save_patient_medication_allergy"),
        path('save_patient_surgery_history/<int:patient_id>/',views.save_patient_surgery_history, name="save_patient_surgery_history"),
        path('save_patient_lifestyle_behavior/<int:patient_id>/',views.save_patient_lifestyle_behavior, name="save_patient_lifestyle_behavior"),
        ...
        path('save_nextprescription/<int:patient_id>/<int:visit_id>/<int:consultation_notes_id>/', views.save_nextprescription, name='nextsave_prescription'),
        path('prescription/<int:patient_id>/<int:visit_id>/<int:consultation_notes_id>/', views.save_prescription, name='save_prescription'),
        path('save_nextlaboratory/<int:patient_id>/<int:visit_id>/<int:consultation_notes_id>/', views.save_nextlaboratory, name='nextsave_laboratory'),
        path('laboratory/<int:patient_id>/<int:visit_id>/<int:consultation_notes_id>/', views.save_laboratory, name='save_laboratory'),
        path('nextsave_remotereferral/<int:patient_id>/<int:visit_id>/<int:consultation_notes_id>/', views.save_nextremotereferral, name='nextsave_remotereferral'),
        ...
        path('save_nextcounsel/<int:patient_id>/<int:visit_id>/<int:consultation_notes_id>/', views.save_nextcounsel, name='nextsave_counsel'),
        path('counsel/<int:patient_id>/<int:visit_id>/<int:consultation_notes_id>/', views.save_counsel, name='save_counsel'),
        path('save_nextremoteprocedure/<int:patient_id>/<int:visit_id>/<int:consultation_notes_id>/', views.save_nextremoteprocedure, name='nextsave_remoteprocedure'),
        ...
        path('save_nextobservation/<int:patient_id>/<int:visit_id>/<int:consultation_notes_id>/', views.save_nextobservation, name='nextsave_observation'),
        ...
        path('import_patient', imports.import_patient, name='import_patient'),
