# Generated by Django 4.2.9 on 2024-04-02 15:20
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('final_diagnosis', models.ManyToManyField(blank=True, related_name='remote_final_notes', to='kahamahmis.diagnosis')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('company', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='kahamahmis.remotecompany')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('patient', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='kahamahmis.remotepatient')),
                ('service', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='kahamahmis.remoteservice')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('consultation', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='kahamahmis.remoteconsultationnotes')),
                ('patient', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='kahamahmis.remotepatient')),
                ('visit', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='kahamahmis.remotepatientvisits')),
            ],
        ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('doctor', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='clinic.staffs')),
                ('name', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='kahamahmis.remoteservice')),
                ('patient', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='kahamahmis.remotepatient')),
                ('visit', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='kahamahmis.remotepatientvisits')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('doctor', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='clinic.staffs')),
                ('imaging', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='kahamahmis.remoteservice')),
                ('patient', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='kahamahmis.remotepatient')),
                ('visit', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='kahamahmis.remotepatientvisits')),
            ],
        ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('consultation', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='kahamahmis.remoteservice')),
        ...
        migrations.AddField(
            ...
            name='patient',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='kahamahmis.remotepatient'),
        ),
        migrations.AddField(
            model_name='remoteconsultationnotes',
            name='provisional_diagnosis',
            field=models.ManyToManyField(blank=True, related_name='remote_provisional_notes', to='kahamahmis.diagnosis'),
        ),
        migrations.AddField(
            model_name='remoteconsultationnotes',
            name='visit',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='kahamahmis.remotepatientvisits'),
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('patient', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='remote_medication_allergies', to='kahamahmis.remotepatient')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True, verbose_name='Created At')),
                ('updated_at', models.DateTimeField(auto_now=True, verbose_name='Updated At')),
                ('patient', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='remote_health_conditions', to='kahamahmis.remotepatient', verbose_name='Patient')),
            ],
        ),
        migrations.CreateModel(
            name='LabTest',
            fields=[
                ...
                ('consultation', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='kahamahmis.remoteconsultationnotes')),
                ('diagnosis', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='kahamahmis.diagnosis')),
                ('patient', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='kahamahmis.remotepatient')),
                ('visit', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='kahamahmis.remotepatientvisits')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True, verbose_name='Created At')),
                ('updated_at', models.DateTimeField(auto_now=True, verbose_name='Updated At')),
                ('patient', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='remote_family_medical_history', to='kahamahmis.remotepatient', verbose_name='Patient')),
            ],
        ),
        migrations.CreateModel(
            name='ChiefComplaint',
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('health_record', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='kahamahmis.healthrecord')),
                ('patient', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='kahamahmis.remotepatient')),
                ('visit', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='kahamahmis.remotepatientvisits')),
            ],
        ),
